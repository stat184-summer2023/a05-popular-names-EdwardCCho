...
my answer here...
I would want to use the table and then filter it by one of the 5 names and reuse the code accordingly. Then group by year and name then summarise to count the total of births per year for each name.
